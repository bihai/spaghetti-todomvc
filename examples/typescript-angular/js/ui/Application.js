...
(function (todos) {
    ...
    (function (ui) {
        'use strict';
        var todomvc = angular.module('todomvc', []).controller('todoCtrl', ui.TodoCtrl).directive('todoBlur', ui.todoBlur).directive('todoFocus', ui.todoFocus).factory('todoStorage', function () {
            return todos.storage.StorageModule.createStorage();
        });
    })(ui = todos.ui || (todos.ui = {}));
})(todos || (todos = {}));
